...
public class CreatingContactTestSuite extends PageObject{
	...
	/*	open();
		...
		dashboard.selectContactOption();
		contact.clickAddContact();
		//contact.verifyCreateContactOptionDisplayed();
		contact.clickCreateContactOption();
		//contact.verifyCreateContactPopupDisplayed();
		contact.enterRequeredDetailsCreateContactPopup(data.firstName,data.lastName,data.email);
