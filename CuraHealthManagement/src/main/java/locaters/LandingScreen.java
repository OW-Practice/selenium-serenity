...
public class LandingScreen {
	...
	public static By txtHeath=By.xpath("//h1[text()='CURA Healthcare Service']");
	public static By lftHamberg=By.cssSelector("[class=\"btn btn-dark btn-lg toggle\"]");
	public static By tabLogin=By.xpath("//*[text()='Login']");
	public static By loginContant=By.xpath("//*[text()='Please login to make appointment.']");
	public static By textContent=By.cssSelector("[class=\"lead\"]");
	public static By fldUsername=By.cssSelector("[placeholder=\"Username\"]:nth-child(1)");
