...
public class screenplaylocaters extends PageObject {
	...
	static Target brand_Logo = Target.the("brandLogo").located(By.cssSelector("[class=\"navbar-brand\"]"));

	static Target signup_Button = Target.the("signupButton").located(By.xpath("//a[text()=\"Sign up\"]"));

	static Target field_Username = Target.the("fieldUsername").located(By.xpath("//input[@id=\"sign-username\"]"));

	static Target field_Password = Target.the("fieldPassword").located(By.xpath("//input[@id=\"sign-password\"]"));

	static Target button_SignUp = Target.the("buttonSignUp").located(By.cssSelector("[class=\"navbar-brand\"]"));
