...
public class PIMempcreationSteps {
	...
	public void user_enter_data_into_the_fields_firstname_and_middlename_and_lastname_and_employeeid(String firstname,
			String middlename, String lastname, String employeeid) {
		PIM.Addingemp(firstname, middlename, lastname, employeeid);
		System.out.println("@And --user enter data into the fields" + firstname + "and" + middlename + "and" + lastname
				+ "and" + employeeid);
	}

	@And("^user click on Create login details button with (.*) and (.*) and (.*)$")
	public void user_click_on_Create_login_details_button_with_NewUsername_and_NewPassword_and_Confirmpassword(
			String NewUsername, String NewPassword, String Confirmpassword) {
		PIM.createnewlogin(NewUsername, NewPassword, Confirmpassword);
		System.out.println(
